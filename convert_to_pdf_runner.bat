@REM Batch convert files in a folder to PDFs
@ECHO OFF

REM Set the path to your Convert-to-PDF project
SET "PROJECT_PATH=C:\Apps\Convert-to-PDF"
...
ECHO ===================================================================
ECHO Convert to PDF - Batch Runner
ECHO ===================================================================
